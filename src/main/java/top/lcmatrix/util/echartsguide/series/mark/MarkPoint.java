...
public class MarkPoint extends AbsMark{
	 ...
	 * @param data
	 */
	public MarkPoint(String symbol, String labelFormatter, List<Point> data){
		this.symbol = symbol;
	 ...
	 * @param data
	 */
	public MarkPoint(String symbol, List<Point> data){
		this.symbol = symbol;
		this.data = data;
	}
